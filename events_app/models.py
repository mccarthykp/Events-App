...
class Guest(db.Model):
    ...
    # events_attending = db.relationship('Event', secondary='event_guest', backref='guests')
...
class Event(db.Model):
    ...
    # guests = db.relationship('Guest', secondary='event_guest', backref='events_attending')
